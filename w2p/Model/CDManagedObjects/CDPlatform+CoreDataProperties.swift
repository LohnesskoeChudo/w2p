//
//  CDPlatform+CoreDataProperties.swift
//  w2p
//
...
extension CDPlatform {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<CDPlatform> {
        return NSFetchRequest<CDPlatform>(entityName: "CDPlatform")
    }
...
extension CDPlatform : Identifiable {
